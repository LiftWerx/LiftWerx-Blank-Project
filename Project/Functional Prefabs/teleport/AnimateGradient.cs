...
public class AnimateGradient : MonoBehaviour {
  ...
  [SerializeField] private Color midBottomColour = new (0.90f, 0.81f, 0.54f, 0.0f);
  // White/Blue
  [SerializeField] private Color endTopColour = new (0.73f, 0.93f, 0.95f, 0.0f);
  [SerializeField] private Color endBottomColour = new (0.13f, 0.41f, 0.51f, 0.0f);
